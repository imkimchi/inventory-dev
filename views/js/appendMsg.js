...
async function appendElements (username, AllConvos) {
    ...
    for(let convo of AllConvos.data) {
            ...
            if(buyOrsell(sender) === 'sell') {
                ...
                if(convo.offered) {
                    $convo.find('.offer-cover').prepend($('<div class="buttons"><div class="handleButton"><div id="accept"> Accept the offer </div></div><div class="handleButton"><div id="counter"> Counter </div></div></div>'))
                }
            }
